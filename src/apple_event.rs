...
impl std::fmt::Display for AppleEvent {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        if let AppleEvent::Unknown(u) = self {
            write!(f, "Unknown({})", u)
        } else {
            let s = match *self {
                AppleEvent::kAEApplicationDied => "kAEApplicationDied",
                AppleEvent::kAEOpenApplication => "kAEOpenApplication",
                AppleEvent::kAEOpenContents => "kAEOpenContents",
                AppleEvent::kAEOpenDocuments => "kAEOpenDocuments",
                AppleEvent::kAEPrintDocuments => "kAEPrintDocuments",
                AppleEvent::kAEQuitApplication => "kAEQuitApplication",
                AppleEvent::kAEReopenApplication => "kAEReopenApplication",
                AppleEvent::kAEShowPreferences => "kAEShowPreferences",
                AppleEvent::kAEGetURL => "kAEGetURL",
                AppleEvent::Unknown(_) => "Unknown(_)",
            };
            write!(f, "Unknown({})", s)
        }
    }
